...
//         animItem.classList.addClass('_active');
//       } else {
//         if (!animItem.classList.contains("_not-active")) {
...
var sliderPortfolio = new Swiper('.portfolio__slider-container', {

  navigation: {
    nextEl: '.portfolio__arrow-prev',
    prevEl: '.portfolio__arrow-next',
  },
  pagination: {
    el: '.portfolio__slider-dots',
    clickable: true,
  },
});
